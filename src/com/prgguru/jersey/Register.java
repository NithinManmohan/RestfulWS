...
//Path: <a class="vglnk" href="http://localhost/" rel="nofollow"><span>http</span><span>://</span><span>localhost</span><span>/</span></a><appln-folder-name>/register
@Path("/register")
public class Register {
	// HTTP Get Method
	@GET
	// Path: <a class="vglnk" href="http://localhost/"
	// rel="nofollow"><span>http</span><span>://</span><span>localhost</span><span>/</span></a><appln-folder-name>/register/doregister
	@Path("/doregister")
	// Produces JSON as response
	@Produces(MediaType.APPLICATION_JSON)
	// Query parameters are parameters: <a class="vglnk" href="http://localhost/"
	// rel="nofollow"><span>http</span><span>://</span><span>localhost</span><span>/</span></a><appln-folder-name>/register/doregister?name=pqrs&username=abc&password=xyz
